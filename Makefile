...
# Project:  ./NN.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile ./NN.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
CFLAGS        = -pipe -O1 -g -Wall -W -fPIC $(DEFINES)
CXXFLAGS      = -pipe -O1 -g -std=gnu++11 -Wall -W -fPIC $(DEFINES)
INCPATH       = -I../NN -I. -I./include -I/usr/lib64/qt5/mkspecs/linux-g++
...
top.o: ./top.cpp ./convolutionrelu.h \
		./fixedpointvariables.h \
		./include/ac_fixed.h \
		./include/ac_int.h \
		./meminterface.h \
